...
var popEmailReader = function popEmailReader(data, eventElement) {
  ...
  if (data[folder][index]['attachment']) {
    data[folder][index]['files'].forEach(function (element) {
      ...
      if (fileType == 'pdf') {
        attachment += "<div class=\"attachment\"><svg width=\"20\" height=\"20\" class=\"va-middle fill-red\"><use xlink:href=\"sprite.svg#icon-file-pdf-solid\"></use></svg><span class=\"va-middle ml-2\">".concat(element, "</span></div>");
      } else if (fileType == 'doc') {
        attachment += "<div class=\"attachment\"><svg width=\"20\" height=\"20\" class=\"va-middle fill-blue\"><use xlink:href=\"sprite.svg#icon-file-word-solid\"></use></svg><span class=\"va-middle ml-2\">".concat(element, "</span></div>");
      } else {
        attachment += "<div class=\"attachment\"><svg width=\"20\" height=\"20\" class=\"va-middle\"><use xlink:href=\"sprite.svg#icon-file-solid\"></use></svg><span class=\"va-middle ml-2\">".concat(element, "</span></div>");
      }
    });
  }
...
/******/ })()
;
//# sourceMappingURL=bundleafd7f2857cd6fab869c5.js.map