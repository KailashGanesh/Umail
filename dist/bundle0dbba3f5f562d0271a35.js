...
var popEmailList = function popEmailList(data, folderName) {
  var openFirstEmail = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
var filterObject = function filterObject(folder, keyValue, search) {
  ...
  if (isMatch) {
    return _globals__WEBPACK_IMPORTED_MODULE_0__["default"].emailData[folder].filter(function (obj) {
      return obj[keyValue].toLowerCase().match(search.toLowerCase());
    });
  }
  return _globals__WEBPACK_IMPORTED_MODULE_0__["default"].emailData[folder].filter(function (obj) {
    return obj[keyValue] == search;
  });
};
...
(0,_js_getData__WEBPACK_IMPORTED_MODULE_0__["default"])(url).then(function () {
  inboxBtn.click();
  emailList.firstElementChild.click();
  (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.updateNumber)();
});
...
sideBar.addEventListener('click', function (e) {
  ...
  if (eventTarget == null) {
    ...
    (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.defaultScreen)(false, true);
    (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.popEmailList)(data, folderName);
  } else if (eventTarget.dataset.type == 'tag') {
    var search = eventTarget.id.slice(0, -3);
    var result = (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.filterObject)('inbox', 'tag', search);
    (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.highlightElement)(eventTarget, 'sidebarMenu');
    (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.defaultScreen)(false, true);
    (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.popEmailList)({
      'inbox': result
    }, 'inbox');
    ...
    (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.openComposeBox)();
  } else {
    return;
  }
});
composeCloseBtn.addEventListener('click', _js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.closeComposeBox);
sendEmailBtn.addEventListener('click', _js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.closeComposeBox);
...
searchBar.addEventListener('keyup', function (e) {
  ...
  if (e.key == 'Enter') {
    ...
    if (currentActiveMenuBtn.dataset.type == 'folder') {
      var result = (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.filterObject)(folderName, 'subject', searchText, true);
      var resultObj = {};
      resultObj[folderName] = result;
      (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.popEmailList)(resultObj, folderName);
    } else if (currentActiveMenuBtn.dataset.type == 'tag') {
      var _result = (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.filterObject)('inbox', 'tag', folderName);
      _js_globals__WEBPACK_IMPORTED_MODULE_1__["default"].emailData[folderName] = _result;
      _result = (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.filterObject)(folderName, 'subject', searchText, true);
      (0,_js_popluateEmailList__WEBPACK_IMPORTED_MODULE_2__.popEmailList)({
        'inbox': _result
      }, 'inbox');
    }
